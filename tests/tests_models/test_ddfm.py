...
class TestDDFM(unittest.TestCase):
    ...
    def test_fit(self):
        ...
        structure_encoder = (r_f_and_nnlinf * 6, r_f_and_nnlinf * 4, r_f_and_nnlinf * 2, r_f_and_nnlinf) if self.sim.poly_degree > 1 else (r_f_and_nnlinf,)
    ...
    def _get_model(self, structure_encoder, jointly_est_var=False):
        ddfm = DDFM(structure_encoder=structure_encoder, factor_order=1,
    ...
    def _single_test_fit(self, ddfm):
        ...
        self.assertIsInstance(ddfm.state_space, StateSpace, msg='Failed to build state_space')
